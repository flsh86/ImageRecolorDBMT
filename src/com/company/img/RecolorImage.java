...
public class RecolorImage {
    ...
    public static void recolorImageMultiThread(BufferedImage originalImage,
        ...
        for(int i = 0; i < numberOfThreads; i++) {
            final int threadMultiplayer = i;

            Thread thread = new Thread(() -> {
                int leftCorner = 0;
                int topCorner = height * threadMultiplayer;
